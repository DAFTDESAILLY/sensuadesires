package com.desailly.chat_sensuadesires.Fragmentos
...
import com.desailly.chat_sensuadesires.Adaptador.AdaptadorUsuario
...
class FragmentoUsuarios : Fragment() {
    ...
    override fun onCreateView(
        ...
        rvUsuario = view.findViewById(R.id.Rv_usuario)
